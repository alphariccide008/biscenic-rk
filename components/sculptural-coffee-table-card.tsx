...
export function SculpturalCoffeeTableCard() {
  return (
    <div className="group cursor-pointer">
      <div className="relative aspect-[3/4] mb-4 overflow-hidden bg-gray-100 rounded-lg border shadow-sm transition-all duration-300 group-hover:shadow-lg">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <Button
            ...
            asChild
          >
            <Link href="/products/sculptural-coffee-table">EXPLORE MORE</Link>
          </Button>
        </div>
        <Button
          variant="outline"
      ...
      <div className="space-y-2">
        <h3 className="font-medium tracking-wide">Sculptural Coffee Table</h3>
