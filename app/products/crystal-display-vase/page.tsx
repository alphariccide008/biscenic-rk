...
export default function CrystalDisplayVasePage() {
  const [selectedImage, setSelectedImage] = useState("/images/crystal-vase.png")
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full aspect-[3/4] mb-4 overflow-hidden rounded-lg border shadow-sm">
              <Image
                src={selectedImage || "/placeholder.svg?height=600&width=450&query=crystal display vase main"}
                alt={product.name}
                fill
            ...
            <div className="grid grid-cols-4 gap-2 w-full max-w-lg">
              {product.images.map((img, index) => (
                ...
                >
                  <Image
                    src={img || "/placeholder.svg?height=96&width=96&query=crystal display vase thumbnail"}
          ...
          <div className="flex flex-col justify-start lg:pl-8">
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 text-sm md:text-base">
                ...
                <li>Dimensions: 10" H x 6" Dia</li>
                <li>Features: Faceted surface, heavy base</li>
                <li>Care: Hand wash with mild soap and water</li>
              </ul>
            </div>
          </div>
        </div>
