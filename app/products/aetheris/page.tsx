...
export default function AetherisProductPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* New Title Section */}
      <section className="bg-white py-16 text-center px-4 md:px-8">
        <h1 className="text-5xl md:text-7xl font-light tracking-wider text-black">AETHERIS</h1>
      </section>

      {/* Video Section */}
      <section className="relative w-full h-[50vh] md:h-[70vh] bg-black flex items-center justify-center">
        <video
      ...
      {/* Image Section */}
      <section className="py-12 md:py-20 px-4 md:px-8 bg-gray-100">
      ...
      <section className="py-12 md:py-20 px-4 md:px-8">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6 md:space-y-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-light mb-3 md:mb-4 tracking-wide">Unveiling AETHERIS</h2>
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-light mb-2 md:mb-3 tracking-wide">Design Philosophy</h3>
              <p className="text-gray-700 leading-relaxed text-sm md:text-base">
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-light mb-2 md:mb-3 tracking-wide">Craftsmanship</h3>
              <p className="text-gray-700 leading-relaxed text-sm md:text-base">
            ...
            <Button
              className="bg-black text-white hover:bg-gray-800 px-6 py-3 text-sm md:px-8 md:py-4 md:text-base tracking-wide"
              asChild
            >
      ...
      <section className="py-12 md:py-20 bg-white px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-light text-center mb-8 md:mb-12 tracking-wide">Explore the Collection</h2>
